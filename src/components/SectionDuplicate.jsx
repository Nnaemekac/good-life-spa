...
const SectionDuplicate = (props) => {
    const { paragraphHeading, mainHeading, mainParagraph, children } = props;
    return (
        <div>
            ...
            <p className='xui-opacity-8 xui-lg-w-fluid-80 xui-w-fluid-100 xui-line-height-1-half xui-font-sz-85 xui-mt-half'>{mainParagraph}</p>
            {children}
        </div>
    );
};
